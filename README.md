...
> A voice-first, agentic, AI-native operating environment built on top of Linux.

[![Status: Pre-Alpha](https://img.shields.io/badge/Status-Pre--Alpha-red.svg)](file:///Users/aryansingh/Documents/Aura-OS/PROGRESS-TRACKER.md)
[![Target: ARM64 Linux](https://img.shields.io/badge/Target-ARM64%20Linux%20(UTM)-blue.svg)](file:///Users/aryansingh/Documents/Aura-OS/PLAN.md)
[![License: Apache 2.0](https://img.shields.io/badge/License-Apache%202.0-green.svg)](LICENSE)
[![Architecture Docs](https://img.shields.io/badge/Docs-Authoritative%20Architecture-purple.svg)](file:///Users/aryansingh/Documents/Aura-OS/ARCHITECTURE.md)

---

## 1. Vision & Core Paradigm

**AURA OS** is a computing environment designed for ambient, voice-driven interaction where autonomous AI agents operate as first-class system primitives. Instead of requiring human operators to manually navigate menus, manipulate window hierarchies, and coordinate disparate applications, AURA elevates user intent to direct, autonomous system execution.

### The Paradigm Shift

```
Traditional Operating System:
Human ───► Applications ───► Actions ───► Manual Verification

AURA OS:
Human ───► Goal ───► Agents ───► Skills & Tools ───► Actions ───► Autonomous Verification
```

In AURA, you do not launch an IDE, navigate to a directory, run a build command, search through terminal backscroll for errors, and manually edit source files. Instead, you declare your goal:
> *"Aura, open my project, run the tests, figure out what's failing, and fix it."*

AURA interprets the goal, synthesizes current desktop and filesystem context, plans a dependency graph of discrete tasks, requests permissions for sensitive actions, spawns specialized agents into sandboxed execution environments, verifies the resolution against compiler/test output, updates its episodic memory, and speaks the verified outcome back to you.
...
AURA OS adheres strictly to 17 core architectural principles:
...
3. **Voice-First, Multi-Modal Fallback**: Natural speech is the primary mode of engagement; high-resolution displays, keyboards, and mice serve as high-bandwidth observability and control fallbacks.
...
10. **Local-First Autonomy**: Core voice processing, memory retrieval, and basic reasoning must be capable of running offline on local silicon.
...
14. **Ambient, Minimalist Native UI**: The desktop shell is an ambient visual feedback canvas (Wayland/GTK4), not a cluttered legacy desktop with persistent chatbot widgets.
15. **Honest Capabilities**: AURA treats LLMs as probabilistic reasoning engines requiring external sandboxes and deterministic tooling, not as artificial general intelligence (AGI).
16. **Subsystem Resilience**: Isolated daemon crashes must not panic the underlying Linux OS or compromise active user sessions.
17. **Hardware Portability**: Developed natively for ARM64 (Apple Silicon virtualization via UTM) while preserving strict architectural paths for eventual x86_64 deployment.
...
```mermaid
graph TD
    subgraph UserSpace["User Space Interface"]
...
For the complete technical blueprint, IPC protocol schemas, and data models, consult the authoritative [ARCHITECTURE.md](file:///Users/aryansingh/Documents/Aura-OS/ARCHITECTURE.md).
...
├── PLAN.md                 # 11-phase implementation roadmap & milestone definitions
├── PROGRESS-TRACKER.md     # Persistent project dashboard, task registry, and agent state
├── UI-REGISTRY.md          # Canonical registry of UI components, screens, and voice states
│
...
│   ├── components/         # UI-001 Orb, UI-002 Voice Overlay, UI-004 Monitor
...
For full phase deliverables, acceptance tests, and risk mitigations, consult [PLAN.md](file:///Users/aryansingh/Documents/Aura-OS/PLAN.md).
...
1. **Read Before Writing**: Always read [README.md](file:///Users/aryansingh/Documents/Aura-OS/README.md), [ARCHITECTURE.md](file:///Users/aryansingh/Documents/Aura-OS/ARCHITECTURE.md), [PLAN.md](file:///Users/aryansingh/Documents/Aura-OS/PLAN.md), [PROGRESS-TRACKER.md](file:///Users/aryansingh/Documents/Aura-OS/PROGRESS-TRACKER.md), and [UI-REGISTRY.md](file:///Users/aryansingh/Documents/Aura-OS/UI-REGISTRY.md) before making architectural modifications.
2. **Synchronize Project State**: Whenever you complete a task or change code, update [PROGRESS-TRACKER.md](file:///Users/aryansingh/Documents/Aura-OS/PROGRESS-TRACKER.md) immediately.
...
- **[ARCHITECTURE.md](file:///Users/aryansingh/Documents/Aura-OS/ARCHITECTURE.md)**: Deep technical architecture specification, subsystem designs, data schemas, IPC protocols, and diagrams.
- **[PLAN.md](file:///Users/aryansingh/Documents/Aura-OS/PLAN.md)**: Detailed engineering phase plan, definition of done, automated test suites, and risk register.
- **[PROGRESS-TRACKER.md](file:///Users/aryansingh/Documents/Aura-OS/PROGRESS-TRACKER.md)**: Live task tracker, component status matrix, known bugs, and developer session notes.
- **[UI-REGISTRY.md](file:///Users/aryansingh/Documents/Aura-OS/UI-REGISTRY.md)**: Canonical registry of all UI components, Wayland screens, visual design tokens, and voice state machines.